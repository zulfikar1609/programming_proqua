      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?= ($active == 'dashboard') ? 'active' : '' ?>"><a href="<?= base_url('dashboard') ?>" class="nav-link ajax-link"><i class="fas fa-fire"></i><span>Dashboard</span></a></li>
            <?php if ($role == 'superadmin'): ?>
              ...
              <li class="<?= ($active == 'diagnosis') ? 'active' : '' ?>"><a href="<?= base_url('diagnosis') ?>" class="nav-link ajax-link"><i class="fas fa-clipboard-list"></i><span>Diagnosis</span></a></li>
            <?php endif; ?>
            <?php if ($role == 'perawat'): ?>
              <li class="<?= ($active == 'pendaftaran') ? 'active' : '' ?>"><a href="<?= base_url('pendaftaran') ?>" class="nav-link ajax-link"><i class="fas fa-folder-plus"></i><span>Pendaftaran</span></a></li>
              <li class="<?= ($active == 'kunjungan') ? 'active' : '' ?>"><a href="<?= base_url('kunjungan') ?>" class="nav-link ajax-link"><i class="fas fa-bed"></i><span>Kunjungan</span></a></li>
